...
public interface TenantDetailsRepository extends JpaRepository<TenantDetails, Long> {
	...
	@Query( value ="SELECT P.PAYMENT_ID,T.TENANT_ID,T.FULL_NAME,T.MOBILE_NO,\r\n"
			...
			+ "P.PRV_PENDING_AMOUNT,P.PRV_MTR_READ,T.ADV_AMOUNT,P.PAID_STATUS,P.CURRENT_BILL, \r\n"
			+ "P.PAID_AMOUNT, P.CUR_PENDING_AMT, P.TOTAL_BILL FROM TBL_MST_HM_PAYMENTDETAILS P\r\n"
